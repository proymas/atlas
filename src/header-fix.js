...
function ensureStyles(){
  ...
  if(!style){
    ...
    style.textContent=`
      ...
      /* Mobile has its own layout. No absolute positioning, no dropdowns, no overlap. */
      @media(max-width:560px){
        ...
        .site-header .atlas-header-center{
          ...
          border-top:1px solid rgba(132,180,240,.10)!important;
      ...
      @media(max-width:390px){
        ...
        .site-header .atlas-header-left-controls{gap:5px!important}
        ...
        .site-header .atlas-account-button{max-width:40vw!important;padding-left:8px!important;padding-right:8px!important;font-size:10px!important}
        .site-header .nav .workspace-open{min-width:78px!important;padding:0 8px!important;font-size:10px!important}
      ...
      @media(max-width:330px){
        .site-header .atlas-header-grid{
          grid-template-columns:minmax(0,1fr)!important;
          grid-template-areas:"left" "right" "center"!important;
          gap:8px!important;
        }
        .site-header .atlas-header-right{
        ...
        .site-header .atlas-account-button{justify-self:start!important;max-width:58vw!important}
        .site-header .nav .workspace-open{justify-self:end!important}
      }
    `;
  }
